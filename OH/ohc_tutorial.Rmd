...
We plot the Indian ocean to check if there is any issues. We have removed small islands and we keep Madagasikara.
```{r}
...
We create the mesh for the Indian ocean with the outer boundary.  We might do a Barrier model on a sphere in the future.  
```{r}
