...
We create the mesh for the Indian ocean with the outer boundary. The cutoff is to remove small island and we keep Madagasikara. We might do a Barrier model in the future.  
```{r}
